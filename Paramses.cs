...
+" where t1.product_id = {0} and(t1.sku_id is null or t1.sku_id = {1}) and t2.type = 'varchar'"
+" union "
...
+" where t4.product_id = {0} and(t4.sku_id is null or t4.sku_id = {1}) and t5.type like 'dimension%'"
+" UNION"
...
+" where t10.product_id = {0} and(t10.sku_id is null or t10.sku_id = {1}) and t11.type = 'color'"
+" union"
...
+" where t13.product_id = {0} and(t13.sku_id is null or t13.sku_id = {1}) and t14.type = 'dimension.weight'", product_id, skus_id);
